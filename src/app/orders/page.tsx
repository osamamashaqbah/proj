        ...
        {orders.map((o) => (
          <div key={o.id} className="card">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="text-silver-bright font-medium">#{o.id.slice(-8)}</div>
              <div className="flex items-center gap-2 text-xs">
                <span className="badge-purple">{o.source}</span>
                <span className="badge-silver">{o.status}</span>
                {o.guaranteeRequest && (
            ...
            <div className="mt-3 grid sm:grid-cols-3 gap-2 text-sm border-t border-purple-800/30 pt-2">
              ...
              <div className="flex justify-between font-semibold text-silver-bright"><span>{t("orders.total")}</span><span>{formatPrice(o.totalCents, o.currency, locale)}</span></div>
            </div>
          </div>
        ))}
      </div>
